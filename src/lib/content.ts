...
export const content = {
  es: {
    ...
    about: {
      ...
      body: [
        "En Quilas nos rodea la naturaleza y eso es, a propósito, lo que hace posible todo lo demás. Aquí puedes bajar el ritmo, reconectar contigo mismo y dejar que la rutina se quede atrás.",
