          ...
          <div className="rounded-3xl bg-card p-6 shadow-sm sm:p-8">
            ...
            <div className="mt-8 flex flex-col gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#FF6984] px-6 font-semibold text-primary-foreground transition-opacity hover:opacity-90"
              >
