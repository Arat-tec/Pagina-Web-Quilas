          ...
          <div className="rounded-3xl bg-card p-6 shadow-sm sm:p-8">
            ...
            <div className="mt-8 flex flex-col gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#FF5877] px-6 font-semibold text-primary-foreground transition-opacity hover:opacity-90"
              >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full border border-border bg-[#33CCFE] px-5 font-semibold text-white transition-opacity hover:opacity-90"
              >
                <Navigation className="size-5" aria-hidden />
                {t.contact.openWaze}
              </a>
